...
within the row for loop, nested for loop for colums and evaluate
the grades for individual portions
use of counters to keep track of valid numbers stored in the matrix cells
calculate the grades
print the grades onto screen
end loop
%}
